...
<div class="offcanvas offcanvas-start bg-black text-white sidebar-nav"
        ...
        <div class="collapse" id="bookmgmt">
          <div>
            <ul class="navbar-nav ps-3">
              ...
              <li>
                <a href="../managebooks.php" class="nav-link active">
      ...
      <li class="nav-item">
        ...
        <div class="collapse" id="studentmgmt">
          <div>
            <ul class="navbar-nav ps-3">
              <li>
                <a href="add-students.html" class="nav-link active">
                  <i class="fa-solid fa-plus me-2"></i>
                  Add Students
                </a>
              </li>
              <li>
                <a href="manage-students.html" class="nav-link active">
                  <i class="fa-solid fa-bars-progress me-2"></i>
                  Manage Students
                </a>
              </li>
      ...
      <li class="nav-item">
        ...
        <div class="collapse" id="bookloan">
          <div>
            <ul class="navbar-nav ps-3">
              <li>
                <a href="./add-loan.html" class="nav-link active">
                  <i class="fa-solid fa-plus me-2"></i>
                  Add new
                </a>
              </li>
              <li>
                <a href="./manager-loan.html"
  ...
  <li class="nav-item">
    <a class="nav-link active" aria-current="page"
      href="./index.html">
      <i
        class="fa-solid fa-right-from-bracket me-3"></i>Log
      Out
    </a>
  </li>
</div>
